...
const IS_HIGH_END_DEVICE = (() => {
	...
	// 大屏幕显示的是一台全尺寸的计算机，现在通常都有超线程。
	// 因此，四核台式机有8个内核。我们将在那里设置更高的最小阈值。
...
// 所有质量全局将通过`configDidUpdate覆盖和更新`.
//

let quality = 1;//质量
let isLowQuality = false;//低质量
let isNormalQuality = true;//正常质量
let isHighQuality = false;//高质量
